...
/**
 * <p>Classe Java de StandardContentContentValueList complex type.
 * 
...
public class StandardContentContentValueList {

    @XmlElement(name = "ContentValueList")
    protected List<StandardContentContentValue> contentValueList;
     ...
     * {@link StandardContentContentValue }
     * 
     * 
     */
    public List<StandardContentContentValue> getContentValueList() {
        if (contentValueList == null) {
            contentValueList = new ArrayList<StandardContentContentValue>();
        }
