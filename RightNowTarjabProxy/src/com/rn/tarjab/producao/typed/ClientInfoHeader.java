...
@XmlRootElement(name = "ClientInfoHeader", namespace = "urn:messages.ws.rightnow.com/v1_3")
public class ClientInfoHeader {

    @XmlElement(name = "AppID", namespace = "urn:messages.ws.rightnow.com/v1_3", required = true)
