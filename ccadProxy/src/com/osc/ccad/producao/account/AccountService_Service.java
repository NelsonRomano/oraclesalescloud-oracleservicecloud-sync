 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/accountService/", wsdlLocation = "https://ccad.crm.us2.oraclecloud.com/crmCommonSalesParties/AccountService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://xmlns.oracle.com/apps/crmCommon/salesParties/accountService/", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://ccad.crm.us2.oraclecloud.com/crmCommonSalesParties/AccountService?WSDL");
    ...
    public AccountService getAccountServiceSoapHttpPort() {
        return super.getPort(new QName("http://xmlns.oracle.com/apps/crmCommon/salesParties/accountService/", "AccountServiceSoapHttpPort"), AccountService.class);
    }
    ...
    public AccountService getAccountServiceSoapHttpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xmlns.oracle.com/apps/crmCommon/salesParties/accountService/", "AccountServiceSoapHttpPort"), AccountService.class, features);
    }
